...
def main():
    ...
    for phase, dataset_opt in sorted(opt["datasets"].items()):
        ...
        train_loader_mask = DataLoader(train_set_mask, batch_size=1,shuffle=False)#  Set shuffle to False to select masks in order
        logger.info(
...
class Datasetset_mask(Dataset):
    ...
    def __getitem__(self, i):
        ...
        return mask   #  0 is masked, 1 is unmasked
